...
void Builtins::Generate_Call(MacroAssembler* masm, ConvertReceiverMode mode) {
  ...
  __ Jump(BUILTIN_CODE(masm->isolate(), CallBoundFunction),
          RelocInfo::CODE_TARGET, false, eq, type, Operand(JS_BOUND_FUNCTION_TYPE));
  ...
  __ Jump(BUILTIN_CODE(masm->isolate(), CallProxy), RelocInfo::CODE_TARGET, false, eq,
...
void Builtins::Generate_Construct(MacroAssembler* masm) {
  ...
  __ Jump(BUILTIN_CODE(masm->isolate(), ConstructBoundFunction),
          RelocInfo::CODE_TARGET, false, eq, scratch, Operand(JS_BOUND_FUNCTION_TYPE));
